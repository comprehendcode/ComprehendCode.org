...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<app-navbar></app-navbar>\n<div class=\"container\">\n    <h1>\n        {{story?.data.title}}\n    </h1>\n    <h4>\n    {{story?.data.author.first_name}} {{story?.data.author.last_name}}\n    </h4>\n    <div class=\"\" [innerHTML]=\"story?.data.body\"></div>\n</div>\n\n<app-footer></app-footer>");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/our-stories/our-stories.component.html":
/*!**********************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/our-stories/our-stories.component.html ***!
  \**********************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<app-navbar></app-navbar>\n<div class=\"container\"> \n  <div class=\"row\">\n    <div class=\"col\">\n      <div id=\"title\" class=\"header\"> Our Stories</div>\n      <div id=\"subtitle\">We share with you stories of people with learning difference.</div>\n      <br>\n      <div class=\"card-deck\">\n      <div *ngFor=\"let post of storyArray\">\n        <div class=\"card\" routerLink=\"{{post.slug}}\">\n          <img src=\"{{post.featured_image}}\" class=\"card-img-top\" alt=\"...\" id=\"image\">\n            <div class=\"card-body\">\n            <h4 class=\"card-title\" id=\"card-title\">{{post.title}}</h4>\n            <p class=\"card-text\">{{post.summary}}</p>\n            </div>\n            <div class=\"card-footer\">\n              <small class=\"text-muted\">By {{post.author.first_name}} {{post.author.last_name}}</small> \n              <br>\n              <small class=\"text-muted\">Date: {{post.published}}</small>\n            </div>\n          </div>\n          <br>\n        </div>\n      </div>\n    </div>\n  </div>\n\n</div>\n<app-footer></app-footer>");
...
/* harmony import */ var _our_progress_our_progress_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./our-progress/our-progress.component */ "./src/app/our-progress/our-progress.component.ts");
/* harmony import */ var _filestack_angular__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @filestack/angular */ "./node_modules/@filestack/angular/fesm2015/filestack-angular.js");
...
/* harmony import */ var _our_stories_our_stories_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./our-stories/our-stories.component */ "./src/app/our-stories/our-stories.component.ts");
/* harmony import */ var _our_stories_detail_our_stories_detail_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./our-stories-detail/our-stories-detail.component */ "./src/app/our-stories-detail/our-stories-detail.component.ts");
...
const routes = [
    ...
    { path: 'our-progress', component: _our_progress_our_progress_component__WEBPACK_IMPORTED_MODULE_11__["OurProgressComponent"] },
    { path: 'our-stories', component: _our_stories_our_stories_component__WEBPACK_IMPORTED_MODULE_14__["OurStoriesComponent"] },
    { path: 'our-stories/:slug', component: _our_stories_detail_our_stories_detail_component__WEBPACK_IMPORTED_MODULE_15__["OurStoriesDetailComponent"] },
    { path: '**', redirectTo: '' },
    { path: 'rss', component: _feed_feed_component__WEBPACK_IMPORTED_MODULE_16__["FeedComponent"] }
];
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _our_progress_our_progress_component__WEBPACK_IMPORTED_MODULE_11__["OurProgressComponent"],
            _our_stories_our_stories_component__WEBPACK_IMPORTED_MODULE_14__["OurStoriesComponent"],
            _our_stories_detail_our_stories_detail_component__WEBPACK_IMPORTED_MODULE_15__["OurStoriesDetailComponent"],
        ...
        imports: [
            ...
            _filestack_angular__WEBPACK_IMPORTED_MODULE_12__["FilestackModule"],
...
let FeedComponent = class FeedComponent {
    constructor() { }
    ngOnInit() {
        _services__WEBPACK_IMPORTED_MODULE_2__["butterService"].feed.retrieve('rss').then((res) => {
            console.log(res.data.data);
            this.rss = res.data.data;
        });
        _services__WEBPACK_IMPORTED_MODULE_2__["butterService"].feed.retrieve('atom').then((res) => {
            console.log(res.data.data);
            this.atom = res.data.data;
        });
        _services__WEBPACK_IMPORTED_MODULE_2__["butterService"].feed.retrieve('sitemap').then((res) => {
            console.log(res.data.data);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("/* Mobile Styles */\n@media only screen and (max-width: 549px) {\n    #mission_statement {\n        padding-top: 1.75em;\n        padding-left: 3em;\n        padding-right: 3em;\n        padding: .75em;\n\n        font-size: 2.2em;\n        font-weight: bold;\n        color: black;\n    }\n    #learn_more {\n      margin-top: 1em;\n      margin-left: 2em;\n      padding: .75em;\n\n    }\n    #mobile-fix{\n        padding-bottom: 22vh;\n    }\n}\n/* Tablet Styles */\n@media only screen and (min-width: 550px) and (max-width: 970px) {\n    #mission_statement {\n        margin-left:1em;\n        padding-top: 1.75em;\n        padding-left: 3em;\n        padding-right: 3em;\n        padding: 1em;\n        font-size: 2.5em;\n        font-weight: bold;\n        color: black;\n    }\n    #learn_more {\n        margin-top: 1em;\n        margin-left: 11em;\n        padding: 1em;\n    }\n    #home {\n        background-image: url('back-01.svg');\n        background-size: 100% 100%;\n        width: 100vw;\n        height: 100vh;\n        background-repeat: no-repeat;\n    }\n\n}\n/* Desktop Styles */\n@media only screen and (min-width: 971px) {\n    #mission_statement{\n        padding-top: 1.75em;\n        padding-left: 3em;\n        padding-right: 3em;\n        font-size: 3.75em;\n        font-weight: bold;\n        color:black\n    }\n    #learn_more {\n      margin-top: 1em;\n      margin-left: 11em;\n      padding: 1em;\n    }\n    #home{ \n        background-image: url('back-01.svg');\n        background-size: 100% 100%;\n        width: 100vw;\n        height: 100vh;\n        background-repeat: no-repeat;\n    }\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
let OurProgressComponent = class OurProgressComponent {
    ...
    fetchPosts() {
        _services_butterCMS_service__WEBPACK_IMPORTED_MODULE_2__["butterService"].content.retrieve(['our-progress'])
            .then((resp) => {
...
/***/ "./src/app/our-stories-detail/our-stories-detail.component.css":
/*!*********************************************************************!*\
  !*** ./src/app/our-stories-detail/our-stories-detail.component.css ***!
  \*********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\nh1, h2, h3, h4, h5 {\n    font-weight: 600;\n    margin-bottom: 1em;\n    margin-top: 1.5em;\n}\n\nul, ol {\n    margin-bottom: 1.25em;\n\n    li {\n    margin-bottom: 0.25em;\n    }\n}\n\np {\n    font-family: Georgia, Cambria, \"Times New Roman\", Times, serif;\n    font-size: 1.25em;\n    line-height: 1.58;\n    margin-bottom: 1.25em;\n    font-weight: 400;\n    letter-spacing: -.003em;\n}\n\n/* Responsive default image width */\n\nimg {\n    max-width: 100%;\n    height: auto;\n    width: auto;\n}\n\n/* Responsive floating */\n\n@media only screen and (min-width: 720px)  {\n    .butter-float-left {\n    float: left;\n    margin: 0px 10px 10px 0px;\n    }\n\n    .butter-float-right {\n    float: right;\n    margin: 0px 0px 10px 10px;\n    }\n}\n\n/* Image caption */\n\nfigcaption {\n    font-style: italic;\n    text-align: center;\n    color: #ccc;\n}\n\np code {\n    padding: 2px 4px;\n    font-size: 90%;\n    color: #c7254e;\n    background-color: #f9f2f4;\n    border-radius: 4px;\n\n}\n\npre {\n    display: block;\n    padding: 1em;\n    margin: 0 0 2em;\n    font-size: 1em;\n    line-height: 1.4;\n    word-break: break-all;\n    word-wrap: break-word;\n    color: #333333;\n    background-color: #f5f5f5;\n}\n/*# sourceMappingURL=data:application/json;base64, */");

/***/ }),

/***/ "./src/app/our-stories-detail/our-stories-detail.component.ts":
/*!********************************************************************!*\
  !*** ./src/app/our-stories-detail/our-stories-detail.component.ts ***!
  \********************************************************************/
/*! exports provided: OurStoriesDetailComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OurStoriesDetailComponent", function() { return OurStoriesDetailComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let OurStoriesDetailComponent = class OurStoriesDetailComponent {
...
OurStoriesDetailComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
OurStoriesDetailComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-our-stories-detail',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./our-stories-detail.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/our-stories-detail/our-stories-detail.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./our-stories-detail.component.css */ "./src/app/our-stories-detail/our-stories-detail.component.css")).default]
    })
...
/***/ "./src/app/our-stories/our-stories.component.css":
/*!*******************************************************!*\
  !*** ./src/app/our-stories/our-stories.component.css ***!
  \*******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("/* Desktop Styles */\n@media only screen and (min-width: 961px) {\n    #card-title{\n        font-weight:500;\n\n    }\n    #title {\n        font-weight: bolder;\n    }\n    .header{\n        font-size: 3rem;\n    }\n    #subtitle{\n        font-size: 1.5rem;\n    }\n    .text{\n        font-size: 1.08rem;\n    }\n    .card{\n        width: 30rem;\n        height: 35rem;\n    }\n    #image{\n        height: 20rem;\n        width:30rem;\n    }\n   \n}\n@media only screen and (max-width: 400px) {\n    #card-title{\n        font-weight:400;\n\n    }\n\n    .header{\n        font-size: 2rem;\n    }\n    #subtitle{\n        font-size: 1rem;\n    }\n    .text{\n        font-size: 1.08rem;\n    }\n    .card{\n        width: 20rem;\n        height: 30rem;\n    }\n    #image{\n        height: 10rem;\n        width:20em;\n    }\n}\n@media only screen and (min-width: 401px) and (max-width: 960px) {\n    #card-title{\n        font-weight:500;\n\n    }\n    .header{\n        font-size: 2rem;\n    }\n    #subtitle{\n        font-size: 1rem;\n    }\n    .text{\n        font-size: 1.08rem;\n    }\n    .card{\n        width: 20rem;\n        height: 30rem;\n    }\n    #image{\n        height: 10rem;\n        width:20rem;\n    }\n\n}\n/*# sourceMappingURL=data:application/json;base64, */");

/***/ }),

/***/ "./src/app/our-stories/our-stories.component.ts":
/*!******************************************************!*\
  !*** ./src/app/our-stories/our-stories.component.ts ***!
  \******************************************************/
/*! exports provided: OurStoriesComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OurStoriesComponent", function() { return OurStoriesComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_butterCMS_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/butterCMS.service */ "./src/app/services/butterCMS.service.ts");
...
let OurStoriesComponent = class OurStoriesComponent {
    constructor() {
        this.storyArray = [];
    }
    ngOnInit() {
    ...
    fetchStories() {
        _services_butterCMS_service__WEBPACK_IMPORTED_MODULE_2__["butterService"].post.list({})
            .then((res) => {
            console.log(res.data.data);
...
OurStoriesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-our-stories',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./our-stories.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/our-stories/our-stories.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./our-stories.component.css */ "./src/app/our-stories/our-stories.component.css")).default]
    })
], OurStoriesComponent);
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var buttercms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! buttercms */ "./node_modules/buttercms/lib/butter.js");
...
const butterService = buttercms__WEBPACK_IMPORTED_MODULE_1___default()('fcd30957922ea69d48a5efc2e6f91576d0712343');
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _butterCMS_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./butterCMS.service */ "./src/app/services/butterCMS.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "butterService", function() { return _butterCMS_service__WEBPACK_IMPORTED_MODULE_1__["butterService"]; });
